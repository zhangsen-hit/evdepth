...
class ConcatStreamingDataPipe(IterableDataset):
    ...
    def __init__(self,
                 datapipe_list: List[Dataset],
                 batch_size: int,
                 num_workers: int,
                 augmentation_pipeline: Optional[Type[IterableDataset]] = None,
        ...
        if augmentation_pipeline is not None:
            ...
            self.augmentation_dp = DummyIterableDataset
    ...
    def _get_zipped_streams(self, datapipe_list: List[Dataset], batch_size: int):
        ...
        assert batch_size > 0
        streams = ZipIterableDataset(
            *(ConcatIterableDataset(*(self.augmentation_dp(MapToIterAdapter(x))
    ...
    def _get_zipped_streams_with_worker_id(self):
        ...
        return ZipIterableDataset(zipped_stream, worker_id_stream)
